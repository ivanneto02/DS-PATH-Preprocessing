...
def step_three_graphs(df=None):
    ...
    # All concepts
    print("> Saving step 3 CUIs pie chart")
    plt.figure()
    ...
    plt.savefig(IMAGES_SAVE_PATH + "/" + f"cuis_step_3_pie_{datetime.now().strftime('%H-%M-%S_%Y-%m-%d')}", bbox_inches='tight', dpi=500)
    plt.close()

    print("> Saving step 3 mapped given sources")
    ...
    plt.xlabel("Source")
    plt.legend(loc="best")
    plt.savefig(IMAGES_SAVE_PATH + "/" + f"present_given_sources_step_3_{datetime.now().strftime('%H-%M-%S_%Y-%m-%d')}", bbox_inches='tight', dpi=500)
    plt.close()

    print("> Saving step 3 mapped given concept type")
    ...
    plt.legend(loc="best")
    plt.savefig(IMAGES_SAVE_PATH + "/" + f"present_given_concept_step_3_{datetime.now().strftime('%H-%M-%S_%Y-%m-%d')}", bbox_inches='tight', dpi=500)
    plt.close()

    print("> Saving step 3 mapped given sources for diseases concept types")
    ...
    plt.xlabel("Source")
    plt.legend(loc="best")
    plt.savefig(IMAGES_SAVE_PATH + "/" + f"present_given_sources_for_diseases_step_3_{datetime.now().strftime('%H-%M-%S_%Y-%m-%d')}", bbox_inches='tight', dpi=500)
    plt.close()

    print("> Saving step 3 mapped given sources for drug concept types")
    ...
    plt.xlabel("Source")
    plt.legend(loc="best")
    plt.savefig(IMAGES_SAVE_PATH + "/" + f"present_given_sources_for_drugs_step_3_{datetime.now().strftime('%H-%M-%S_%Y-%m-%d')}", bbox_inches='tight', dpi=500)
    plt.close()
